...
public class FancyAlertDialog {
    ...
    private FancyAlertDialog(OneBuilder builder){
        this.title=builder.title;
        this.message=builder.message;
        this.activity=builder.activity;
        this.icon=builder.icon;
    ...
    public static class OneBuilder{
        private String title,message,positiveBtnText,negativeBtnText;
        private Activity activity;
        private int icon;
        private Icon visibility;
        ...
        public OneBuilder(Activity activity){
            this.activity=activity;
        }


        public OneBuilder setTitle(String title){
            this.title=title;
            return this;
        }

        public OneBuilder setBackgroundColor(int bgColor){
            this.bgColor=bgColor;
            return this;
        }

        public OneBuilder setMessage(String message){
            this.message=message;
            return this;
        }

        public OneBuilder setPositiveBtnText(String positiveBtnText){
            this.positiveBtnText=positiveBtnText;
            return this;
        }

        public OneBuilder setPositiveBtnBackground(int pBtnColor){
            this.pBtnColor=pBtnColor;
            return this;
        }

        public OneBuilder setNegativeBtnText(String negativeBtnText){
            this.negativeBtnText=negativeBtnText;
            return this;
        }

        public OneBuilder setNegativeBtnBackground(int nBtnColor){
            this.nBtnColor=nBtnColor;
            return this;
        }
        ...
        //setIcon
        public OneBuilder setIcon(int icon, Icon visibility){
            this.icon=icon;
            this.visibility=visibility;
            return this;
        }

        public OneBuilder setAnimation(Animation animation){
            this.animation=animation;
            return this;
        }

        //set Positive listener
        public OneBuilder OnPositiveClicked(FancyAlertDialogListener pListener){
            this.pListener=pListener;
            return this;
        }

        //set Negative listener
        public OneBuilder OnNegativeClicked(FancyAlertDialogListener nListener){
            this.nListener=nListener;
            return this;
        }

        public OneBuilder isCancellable(boolean cancel){
            this.cancel=cancel;
            return this;
        }
