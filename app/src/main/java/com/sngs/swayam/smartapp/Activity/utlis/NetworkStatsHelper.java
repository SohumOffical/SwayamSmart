package com.sngs.swayam.smartapp.Activity.utlis;
...
public class NetworkStatsHelper {
    ...
    public long getPackageRxBytesWifi(long start,long end) {
        NetworkStats networkStats = null;
        networkStats = networkStatsManager.queryDetailsForUid(
    ...
    public long getPackageTxBytesWifi(long start,long end) {
        NetworkStats networkStats = null;
        networkStats = networkStatsManager.queryDetailsForUid(
                ConnectivityManager.TYPE_WIFI,
                "",
