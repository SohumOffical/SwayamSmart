...
import com.sngs.swayam.smartapp.Activity.utlis.theme3bottomnavigation.runAfterDelay
import com.sngs.swayam.smartapp.R
import kotlinx.android.extensions.LayoutContainer
import kotlinx.android.synthetic.main.theme3_bottom_navigation_cell.view.*
...
class BottomNavigationCell : RelativeLayout, LayoutContainer {
    ...
    private fun initializeView() {
        allowDraw = true
        containerView = LayoutInflater.from(context).inflate(R.layout.theme3_bottom_navigation_cell, this)
        draw()
    }
